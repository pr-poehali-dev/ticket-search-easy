...
export default function AirportTicker() {
  ...
  return (
    <div className="bg-[#fff3c4] border-b border-[#f0d97a] text-[#7a5a00] overflow-hidden relative">
      <div className="max-w-7xl mx-auto flex items-center gap-3 pr-2">
        <div className="flex-shrink-0 flex items-center gap-2 pl-4 py-2 bg-[#ffe680] border-r border-[#f0d97a]">
